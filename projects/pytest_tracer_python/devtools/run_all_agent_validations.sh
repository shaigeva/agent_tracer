...
# Run all Python validation steps and only print output on failure
...
# Exclude sample_project fixtures from type checking - they have their own import structure
...
echo "✅ All Python validations passed (lint, format, type check, tests)"
